return { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>th", builtin.help_tags, { desc = "[S]earch [H]elp - Telescope" })
        vim.keymap.set("n", "<leader>tk", builtin.keymaps, { desc = "[S]earch [K]eymaps - Telescope" })
        vim.keymap.set("n", "<leader>tf", builtin.find_files, { desc = "[S]earch [F]iles - Telescope" })
        vim.keymap.set("n", "<leader>ts", builtin.builtin, { desc = "[T]elescope [S]earch - Telescope" })
        ...
        end, { desc = "[T]elescope [G]rep [S]earch - Telescope"})
